...
app = Flask(__name__)
# Render-дегі фронтендпен (Netlify) байланыс үшін CORS қосу:
CORS(app) 

# 1. API кілтін Render Environment Variables бөлімінен алады
API_KEY = os.environ.get("AIzaSyBAcpHWaDz8HHjNM1dUM661rcad7EBDMuM")
...
# Сен сұраған ең жаңа және жылдам модель (Gemini 2.0 деңгейіндегі эксп. модель)
...
if __name__ == '__main__':
    # 2. Render-дің портына автоматты бейімделу
